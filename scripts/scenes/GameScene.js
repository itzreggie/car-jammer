...
export default class GameScene extends Phaser.Scene {
	...
	setHighScore() {
		...
		try {
			let highScore = localStorage.getItem("carJammerHighScore");
			...
			localStorage.setItem("carJammerHighScore", score);
	...
	setGameOver() {
		...
		try {
			const highScore = localStorage.getItem("carJammerHighScore");
